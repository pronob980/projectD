			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-md-6 col-sm-8 col-xs-12">
					<div class="main-content">
						<article>
							<div class="post-img">
								<a href="details.php" target="_blank"><img class="img-responsive" src="asset/images/post-img-1.jpg" alt="Post"/></a>
							</div>
							<a href="details.php" target="_blank" class="btn btn-default btn-sm btn-category" type="submit">business</a>
							<a href="details.php" target="_blank"><h2 class="post-title">React To The Future With Isomorphic Apps</h2></a>
							<div class="post-meta">
						...
						<article>
							<div class="post-img">
								<a href="details.php" target="_blank"><img class="img-responsive" src="asset/images/post-img-2.jpg" alt="Post"/></a>
							</div>
							<a href="details.php" target="_blank" class="btn btn-default btn-sm btn-category" type="submit">nature</a>
							<a href="details.php" target="_blank"><h2 class="post-title">The Current State Of E-Commerce Filtering</h2></a>
							<div class="post-meta">
								<span><a href="#"><i class="fa fa-share-alt post-meta-icon"></i> 400 Shares </a></span>
								<span><a href="#"><i class="fa fa-comments post-meta-icon"></i> 20 Comments </a></span>
								<span><a href="#"><i class="fa fa-calendar-check-o post-meta-icon"></i> april 13, 2015 </a></span>
						...
						<article>
							<div class="post-img">
								<a href="details.php" target="_blank"><img class="img-responsive" src="asset/images/post-img-3.jpg" alt="Post"/></a>
							</div>
							<a href="details.php" target="_blank" class="btn btn-default btn-sm btn-category" type="submit">nature</a>
							<a href="details.php" target="_blank"><h2 class="post-title">The Current State Of E-Commerce Filtering</h2></a>
							<div class="post-meta">
						...
						<article>
							<div class="post-img">
								<a href="details.php" target="_blank"><img class="img-responsive" src="asset/images/post-img-9.jpg" alt="Post"/></a>
							</div>
							<a href="details.php" target="_blank" class="btn btn-default btn-sm btn-category" type="submit">nature</a>
							<a href="details.php" target="_blank"><h2 class="post-title">Polynesia is as close to fantasy</h2></a>
							<div class="post-meta">
								<span><a href="#"><i class="fa fa-share-alt post-meta-icon"></i> 400 Shares </a></span>
								<span><a href="#"><i class="fa fa-comments post-meta-icon"></i> 20 Comments </a></span>
								<span><a href="#"><i class="fa fa-calendar-check-o post-meta-icon"></i> april 13, 2015 </a></span>
						...
						<article>
							<div class="post-img">
								<a href="details.php" target="_blank"><img class="img-responsive" src="asset/images/post-img-5.jpg" alt="Post"/></a>
							</div>
							<a href="details.php" target="_blank" class="btn btn-default btn-sm btn-category" type="submit">nature</a>
							<a href="details.php" target="_blank"><h2 class="post-title">Polynesia is as close to fantasy</h2></a>
							<div class="post-meta">
						...
						<article>
							<div class="post-img">
								<a href="details.php" target="_blank"><img class="img-responsive" src="asset/images/post-img-6.jpg" alt="Post"/></a>
							</div>
							<a href="details.php" target="_blank" class="btn btn-default btn-sm btn-category" type="submit">nature</a>
							<a href="details.php" target="_blank"><h2 class="post-title">Polynesia is as close to fantasy</h2></a>
							<div class="post-meta">
						...
						<article>
							<div class="post-img">
								<a href="details.php" target="_blank"><img class="img-responsive" src="asset/images/post-img-7.jpg" alt="Post"/></a>
							</div>
							<a href="details.php" target="_blank" class="btn btn-default btn-sm btn-category" type="submit">nature</a>
							<a href="details.php" target="_blank"><h2 class="post-title">Polynesia is as close to fantasy</h2></a>
							<div class="post-meta">
						...
						<article>
							<div class="post-img">
								<a href="details.php" target="_blank"><img class="img-responsive" src="asset/images/post-img-10.jpg" alt="Post"/></a>
							</div>
							<a href="details.php" target="_blank" class="btn btn-default btn-sm btn-category" type="submit">people</a>
							<a href="details.php" target="_blank"><h2 class="post-title">Final 'Top Gear' footage with Jeremy Clarkson will be shown, says BBCas one can get</h2></a>
							<div class="post-meta">
								<span><a href="#"><i class="fa fa-share-alt post-meta-icon"></i> 400 Shares </a></span>
								<span><a href="#"><i class="fa fa-comments post-meta-icon"></i> 20 Comments </a></span>
								<span><a href="#"><i class="fa fa-calendar-check-o post-meta-icon"></i> april 13, 2015 </a></span>
